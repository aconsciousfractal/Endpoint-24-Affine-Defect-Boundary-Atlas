...
| C4 | B3 has 60 records and 15 endpoint transport orbits selected by selected-value non-affineness. | CL3 certified finite result | `results/ITEM7_PAPER_LOCAL_ENDPOINT_TRANSPORT_PACKAGE.json`, `results/ITEM8B_FREENESS_COUNT_REDUCTION.json` | paper-local finite theorem | non-enumerative count-60 proof |
