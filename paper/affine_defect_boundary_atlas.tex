...
\begin{abstract}
We extract a paper-local finite theorem from the certified endpoint-24
...
\input{sections/03_boundary_theorem}
\input{generated/source_backed_tables}
\FloatBarrier
\input{sections/04_certificate_spine}
\input{sections/05_public_package}
\FloatBarrier
