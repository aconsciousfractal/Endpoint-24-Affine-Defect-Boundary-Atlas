...
This manuscript is planned as a follow-up to the public order-four magic-square companion
paper.  Its object is narrower: the certified endpoint-24 boundary atlas inside
the development extension.  The earlier paper isolates \(24\) as a structured
